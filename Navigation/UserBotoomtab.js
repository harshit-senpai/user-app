                ...
                <Tab.Screen options={{
                    ...
                    tabBarIcon: ({ focused }) => {
                        return (
                            ...
                            <Image style={{
                                color: focused ? "rgba(248, 89, 53, 1)" : "#000"
                            }} source={require('../Images/donation.png')}></Image>
                        )
                    }
                }} name="donation" component={Donationstack} />
                ...
                <Tab.Screen options={{
                    ...
                    tabBarIcon: ({ focused }) => {
                        return (
                            ...
                            <Image style={{
                                color: focused ? "rgba(248, 89, 53, 1)" : "#000"
                            }} source={require('../Images/organicon.png')}></Image>
                        )
                    }
                }} name="NGO" component={StackOrgnation} />
