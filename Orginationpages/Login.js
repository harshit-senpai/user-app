...
const Loginowner = ({ navigation }) => {
    ...
    const login = async () => {
        setLoad(true)
        if (email && password) {
            let data = await fetch(`https://noida-server.vercel.app/ngo/login`, {
                method: "post",
            ...
            if (data.code === 200) {
                ...
                setLoad(false)
                navigation.navigate('orgnigation')
            }
            else {
        ...
        <View style={{ flex: 1, }}>
            <ScrollView>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            fontWeight: "bold"
                        }} onPress={() => navigation.navigate('forgetowner')}>Forgot Password?</Text>
                ...
                <View style={{
                    ...
                    <Text style={{
                        fontSize: 20
                    }} onPress={() => navigation.navigate('signupowner')}>Don't Have a account? <Text style={{ color: "rgba(45, 142, 254, 1)" }}>Sign up</Text></Text>
                </View>
